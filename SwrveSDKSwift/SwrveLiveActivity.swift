...
extension SwrveLiveActivity {
    ...
    @discardableResult class func sendStartEvent<T: ActivityAttributes>(
        ...
        dynamicContentDict: [String: Any]) -> NSMutableDictionary? {
    ...
    @discardableResult class func sendUpdateEvent(
        ...
        type: String,
        token: String? = nil,
        uniqueActivityId: String) -> NSMutableDictionary? {
        guard let _ = swrve else { return nil }
        guard let _ = swrveCommon else { return nil }
...
private extension SwrveLiveActivity {
    ...
    class func observePushTokenUpdates<T: ActivityAttributes>(activityId: String, activity: Activity<T>) {
        Task {
            // Save activity
    ...
    class func observeActivityStateUpdates<T: ActivityAttributes>(activityId: String, activity: Activity<T>) {
        Task {
...
extension SwrveLiveActivity: ActivityAuthorizationInfoProtocol {
    ...
    @objc public func pushToStartToken() -> String? {
        return SwrveLiveActivity.currentPushToStartToken
    }
}
